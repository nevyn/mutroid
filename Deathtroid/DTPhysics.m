...
-(id)init;
{
    ...
    [pairs addObject:[[DTCollisionPair alloc] initWithClassA:[DTEntityPlayer class] b:[DTEntityDoor class] action:^(DTEntity *a, DTEntity *b) {
        if(b.world.server)
            [b.world.server teleportPlayer:[b.world.server playerForEntity:a] toPosition:((DTEntityDoor*)b).destinationPosition inRoomNamed:((DTEntityDoor*)b).destinationRoom transitionDirection:[b lookDirection]];
    }]];
